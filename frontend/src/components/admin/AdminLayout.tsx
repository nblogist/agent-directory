    ...
    <div className="flex h-screen overflow-hidden" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <aside className="w-64 flex-shrink-0 border-r border-dark-border bg-dark-bg flex flex-col">
        ...
        <nav className="flex-1 px-4 space-y-1">
          <NavLink to="/admin/dashboard" end className={({ isActive }) => `flex items-center gap-3 px-3 py-2 rounded-lg transition-colors ${isActive ? 'bg-primary/10 text-primary' : 'text-theme-text-secondary hover:bg-dark-surface'}`}>
            <span className="material-symbols-outlined">dashboard</span>
            <span className="text-sm font-medium">Dashboard</span>
          </NavLink>
          <NavLink to="/admin/api" className={({ isActive }) => `flex items-center gap-3 px-3 py-2 rounded-lg transition-colors ${isActive ? 'bg-primary/10 text-primary' : 'text-theme-text-secondary hover:bg-dark-surface'}`}>
        ...
        <div className="p-4 border-t border-dark-border space-y-2">
          ...
          <button onClick={handleLogout} className="w-full flex items-center justify-center gap-2 text-theme-text-secondary hover:text-red-400 hover:bg-red-400/5 py-2 rounded-lg transition-colors text-sm font-medium">
      ...
      <main className="flex-1 overflow-y-auto bg-dark-bg">
        <header className="h-16 border-b border-dark-border bg-dark-bg/50 backdrop-blur-md flex items-center justify-between px-8 sticky top-0 z-10">
          <div className="flex items-center flex-1 max-w-xl">
            <form onSubmit={e => {
              ...
              <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-theme-text-secondary">search</span>
              <input
                className="w-full pl-10 pr-10 py-2 bg-dark-surface/50 border-none rounded-lg focus:ring-2 focus:ring-primary text-sm"
