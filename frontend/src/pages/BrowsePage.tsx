...
export default function BrowsePage() {
  ...
  return (
    <div className="flex flex-1 max-w-[1440px] mx-auto w-full overflow-hidden">
      ...
      {/* Sidebar */}
      <aside className="w-72 shrink-0 border-r border-dark-border flex-col bg-dark-bg hidden lg:flex overflow-y-auto custom-scrollbar">
      ...
      {/* Main Content */}
      <section className="flex-1 flex flex-col min-w-0 bg-dark-bg/30 overflow-y-auto custom-scrollbar">
